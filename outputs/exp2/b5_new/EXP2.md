...
架構 L3b（shared selector、無 q_tau、flat）、B=8、c=1、epochs 1、lr 0.001、beta_s 0.1、beta_u 0.1、prior discriminative、λ_kd=1.0 λ_eq=1.0 λ_r=1.0（全程固定，未調）、replay_k=1、seeds [0]。
...
|---|---|---|---|---|---|---|---|---|---|---|
| A5 | Ours (Replay+KD+eq) | 1 | 0.8645 ± 0.0000 | 0.7064 ± 0.0000 | +8.26 ± +0.00 | +22.04 ± +0.00 | 0.1361 ± 0.0000 | 0.1553 ± 0.0000 | 0.2113 ± 0.0000 | 0.0801 ± 0.0000 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tcga_esca | 15 | 1.0000 ± 0.0000 | 0.8000 ± 0.0000 | +20.00 ± +0.00 | 0.3333 ± 0.0000 | +53.33 ± +0.00 | 0.6667 ± 0.0000 | 0.0133 ± 0.0000 | 0.00225 ± 0.00000 | 0.3444 ± 0.0000 | 27.0 ± 0.0 | -5.5 ± 0.0 |
| tcga_rcc | 76 | 0.9605 ± 0.0000 | 0.9342 ± 0.0000 | +2.63 ± +0.00 | 0.9079 ± 0.0000 | +5.26 ± +0.00 | 0.0395 ± 0.0000 | 0.1263 ± 0.0000 | 0.00220 ± 0.00000 | 0.0779 ± 0.0000 | 144.3 ± 0.0 | 110.1 ± 0.0 |
| tcga_brca | 93 | 0.8925 ± 0.0000 | 0.8710 ± 0.0000 | +2.15 ± +0.00 | 0.7634 ± 0.0000 | +7.53 ± +0.00 | 0.1075 ± 0.0000 | 0.2686 ± 0.0000 | 0.00186 ± 0.00000 | 0.0435 ± 0.0000 | 134.0 ± 0.0 | 109.0 ± 0.0 |
| tcga_lung | 95 | 0.8526 ± 0.0000 | 0.8526 ± 0.0000 | +0.00 ± +0.00 | 0.8211 ± 0.0000 | +0.00 ± +0.00 | 0.0316 ± 0.0000 | 1.0000 ± 0.0000 | 0.00230 ± 0.00000 | 0.0000 ± 0.0000 | 145.2 ± 0.0 | 145.2 ± 0.0 |
...
逐 slide 預測：`outputs/exp2/b5_new/per_slide/*.json`
