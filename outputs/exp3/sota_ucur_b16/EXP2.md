...
架構 L3b（shared selector、無 q_tau、flat）、B=16、c=1、epochs 5、lr 0.001、beta_s 0.1、beta_u 0.1、prior discriminative、λ_kd=1.0 λ_eq=1.0 λ_r=1.0（全程固定，未調）、replay_k=1、seeds [10]。
...
n（test）：lung 90、brca 91、rcc 74、esca 14。⚠️ esca n=14，一張 slide = 6.67 pp，**esca 上小於 6.67 pp 的差異一律視為不可區分**。
...
|---|---|---|---|---|---|---|---|---|---|---|
| A5 | Ours (Replay+KD+eq) | 1 | 0.9189 ± 0.0000 | 0.8294 ± 0.0000 | +0.45 ± +0.00 | +3.16 ± +0.00 | 0.2738 ± 0.0000 | 0.0074 ± 0.0000 | 0.1046 ± 0.0000 | 0.4380 ± 0.0000 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| tcga_lung | 90 | 0.8556 ± 0.0000 | 0.8667 ± 0.0000 | -1.11 ± +0.00 | 0.7778 ± 0.0000 | +7.78 ± +0.00 | 0.1222 ± 0.0000 | 0.1130 ± 0.0000 | 0.00605 ± 0.00000 | 0.0034 ± 0.0000 | 20.7 ± 0.0 | 118.3 ± 0.0 |
| tcga_brca | 91 | 0.9011 ± 0.0000 | 0.8901 ± 0.0000 | +1.10 ± +0.00 | 0.8352 ± 0.0000 | +4.40 ± +0.00 | 0.0549 ± 0.0000 | 0.3714 ± 0.0000 | 0.00458 ± 0.00000 | 0.0104 ± 0.0000 | 75.4 ± 0.0 | 127.3 ± 0.0 |
| tcga_rcc | 74 | 0.9324 ± 0.0000 | 0.9189 ± 0.0000 | +1.35 ± +0.00 | 0.9189 ± 0.0000 | -2.70 ± +0.00 | 0.0270 ± 0.0000 | 0.3370 ± 0.0000 | 0.00353 ± 0.00000 | 0.0085 ± 0.0000 | 91.5 ± 0.0 | 122.0 ± 0.0 |
| tcga_esca（不可區分） | 14 | 1.0000 ± 0.0000 | 1.0000 ± 0.0000 | +0.00 ± +0.00 | 0.7857 ± 0.0000 | +0.00 ± +0.00 | 0.2143 ± 0.0000 | 1.0000 ± 0.0000 | 0.01073 ± 0.00000 | 0.0000 ± 0.0000 | 19.6 ± 0.0 | 19.6 ± 0.0 |
...
逐 slide 預測：`outputs/exp2/sota_ucur_b16/per_slide/*.json`
